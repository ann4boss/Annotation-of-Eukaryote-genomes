...
#==============================================================================
# SCRIPT: 19_prep_genespace_inputs.sh
...
grep -P "\tgene\t" "$COURSEDIR/data/Lian_et_al/gene_gff/selected/Est-0.EVM.v3.5.ann.protein_coding_genes.gff" | awk 'BEGIN{OFS="\t"} {split($9,a,";"); split(a[1],b,"="); print $1, $4-1, $5, b[2]}' > Est-0.bed
grep -P "\tgene\t" "$COURSEDIR/data/Lian_et_al/gene_gff/selected/Ice-1.EVM.v3.5.ann.protein_coding_genes.gff" | awk 'BEGIN{OFS="\t"} {split($9,a,";"); split(a[1],b,"="); print $1, $4-1, $5, b[2]}' > Ice-1.bed
...
PEPTIDE_2_FILE="$LIAN_DATA/genome/selected/${ACCESSION_2}.fasta"
...
PEPTIDE_3_FILE="$LIAN_DATA/genome/selected/${ACCESSION_3}.fasta"
